...
return (function (p__21310){var map__21311 = p__21310;var map__21311__$1 = ((cljs.core.seq_QMARK_.call(null,map__21311))?cljs.core.apply.call(null,cljs.core.hash_map,map__21311):map__21311);var err = map__21311__$1;var line = cljs.core.get.call(null,map__21311__$1,new cljs.core.Keyword(null,"line","line",1017226086));var character = cljs.core.get.call(null,map__21311__$1,new cljs.core.Keyword(null,"character","character",2578099867));var reason = cljs.core.get.call(null,map__21311__$1,new cljs.core.Keyword(null,"reason","reason",4373906870));var evidence = cljs.core.get.call(null,map__21311__$1,new cljs.core.Keyword(null,"evidence","evidence",1396871625));var start = (character - 1);var start__$1 = (((cljs.core.count.call(null,evidence) <= start))?(start - 2):start);var rem = cljs.core.subs.call(null,(function (){var or__19803__auto__ = evidence;if(cljs.core.truth_(or__19803__auto__))
{return or__19803__auto__;
} else
{return "";
}
})(),start__$1);var end = (start__$1 + rem.indexOf(cljs.core.re_find.call(null,/.\b/,rem)));return new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"message","message",1968829305),reason,new cljs.core.Keyword(null,"severity","severity",2492204655),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"from","from",1017056028),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(line - 1),start__$1], null),new cljs.core.Keyword(null,"to","to",1013907949),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(line - 1),end], null)], null);
});})(results))

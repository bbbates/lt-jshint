...
goog.require('lt.objs.editor');
goog.require('lt.objs.command');
lt.object.object_STAR_.call(null,new cljs.core.Keyword("lt.plugins.lt-jshint","js-hinter","lt.plugins.lt-jshint/js-hinter",2702469257),new cljs.core.Keyword(null,"behaviors","behaviors",607554515),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("lt.plugins.lt-jshint","do-jshint","lt.plugins.lt-jshint/do-jshint",3393188835)], null),new cljs.core.Keyword(null,"linter-name","linter-name",2860858810),"jshint",new cljs.core.Keyword(null,"init","init",1017141378),(function (this$,_,js_hint_opts){return lt.object.merge_BANG_.call(null,this$,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"options","options",4059396624),js_hint_opts], null));
}));
...
return (function (p__21306){var map__21307 = p__21306;var map__21307__$1 = ((cljs.core.seq_QMARK_.call(null,map__21307))?cljs.core.apply.call(null,cljs.core.hash_map,map__21307):map__21307);var err = map__21307__$1;var line = cljs.core.get.call(null,map__21307__$1,new cljs.core.Keyword(null,"line","line",1017226086));var character = cljs.core.get.call(null,map__21307__$1,new cljs.core.Keyword(null,"character","character",2578099867));var reason = cljs.core.get.call(null,map__21307__$1,new cljs.core.Keyword(null,"reason","reason",4373906870));var evidence = cljs.core.get.call(null,map__21307__$1,new cljs.core.Keyword(null,"evidence","evidence",1396871625));var start = (character - 1);var start__$1 = (((cljs.core.count.call(null,evidence) <= start))?(start - 2):start);var rem = cljs.core.subs.call(null,evidence,start__$1);var end = (start__$1 + rem.indexOf(cljs.core.re_find.call(null,/.\b/,rem)));return new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"message","message",1968829305),reason,new cljs.core.Keyword(null,"severity","severity",2492204655),new cljs.core.Keyword(null,"error","error",1110689146),new cljs.core.Keyword(null,"from","from",1017056028),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(line - 1),start__$1], null),new cljs.core.Keyword(null,"to","to",1013907949),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(line - 1),end], null)], null);
});})(results))
